          ...
          <div className="grid grid-cols-2 gap-12 md:gap-24">
            ...
            <div>
              ...
              <ul className="space-y-4 font-body text-parchment/80">
                ...
                <li>
                  <a href="https://www.instagram.com/aatmaya_sm/" target="_blank" rel="noopener noreferrer" className="hover:text-mystic-gold transition-colors flex items-center gap-2">
                    <InstagramIcon /> @aatmaya_sm
                  </a>
                </li>
              </ul>
            </div>
