        ...
        <section ref={sectionRef} className="relative min-h-screen py-24 px-6 bg-void flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative w-full max-w-7xl mx-auto text-center z-10">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className={`relative w-full max-w-[95vw] md:max-w-[1200px] mx-auto rounded-xl p-2 md:p-8 transition-all duration-700 ${isAutoOpening ? 'shadow-[0_0_80px_rgba(212,175,55,0.3)]' : 'shadow-2xl'}`}
                    style={{
                ...
                >
                    ...
                    <div className="hidden md:block absolute top-4 left-4 w-12 h-12 border-t-2 border-l-2 border-mystic-gold/60 rounded-tl-lg"></div>
                    <div className="hidden md:block absolute top-4 right-4 w-12 h-12 border-t-2 border-r-2 border-mystic-gold/60 rounded-tr-lg"></div>
                    <div className="hidden md:block absolute bottom-4 left-4 w-12 h-12 border-b-2 border-l-2 border-mystic-gold/60 rounded-bl-lg"></div>
                    <div className="hidden md:block absolute bottom-4 right-4 w-12 h-12 border-b-2 border-r-2 border-mystic-gold/60 rounded-br-lg"></div>
                    ...
                    <div className="relative z-10 w-full flex items-center justify-center">
                        <iframe
                            ...
                            className="w-full h-[450px] md:h-[700px] border-0 rounded-lg bg-transparent"
                            allowFullScreen
                        />
                    </div>
                </motion.div>
