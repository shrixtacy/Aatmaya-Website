        ...
        <section ref={sectionRef} className="relative min-h-screen py-24 px-6 bg-void flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative w-full max-w-7xl mx-auto text-center z-10">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className={`relative mx-auto rounded-xl p-2 md:p-8 transition-all duration-700 ${isAutoOpening ? 'shadow-[0_0_80px_rgba(212,175,55,0.3)]' : 'shadow-2xl'}`}
                    style={{
                ...
                >
                        ...
                        <iframe
                            ...
                            className="relative z-10 w-full max-w-[1200px] h-[400px] md:h-[700px] border-0 rounded-lg bg-transparent"
                            allowFullScreen
                        />
                    </motion.div>
            </div>
